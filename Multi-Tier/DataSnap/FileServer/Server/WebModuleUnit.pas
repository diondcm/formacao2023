...
procedure TWebModule1.DSServerClassBlockChainGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := Server.Methods.BlockChain.TSMBlockChain;
end;

procedure TWebModule1.DSServerClassFilesGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := Server.Methods.Geral.TSMGeral.ClassName
